...
@Autonomous(name = "Super cool autonomous", group = "Robot", preselectTeleOp = "Duo Driver Controlled")
public class AutonomousOnRoids extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // For autonomous, we want: Four sample + park in player area for max points.
        // If possible, we want to go for 5 but that is rare, and requires grabbing a piece from the middle
        runAuto();
