...
@Autonomous(name = "Simple drive forward autonomous", group = "Robot", preselectTeleOp = "Duo Driver Controlled")
public class DriveForwardSimpleAuto extends LinearOpMode {
